...
class RevenuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create revenue" do
    assert_difference("Revenue.count") do
      post revenues_url, params: { revenue: { amount: @revenue.amount, name: @revenue.name, revenue_date: @revenue.revenue_date } }
    end
  ...
  test "should update revenue" do
    patch revenue_url(@revenue), params: { revenue: { amount: @revenue.amount, name: @revenue.name, revenue_date: @revenue.revenue_date } }
